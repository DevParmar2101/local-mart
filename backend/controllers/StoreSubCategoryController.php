...
class StoreSubCategoryController extends Controller
{
    ...
    /**
     * Lists all StoreSubCategory models.
     *
     * @return string
     */
    public function actionIndex()
    {
        $searchModel = new StoreSubCategorySearch();
    ...
    /**
     * Displays a single StoreSubCategory model.
     * @param int $id ID
     * @return string
    ...
    /**
     * Finds the StoreSubCategory model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param int $id ID
     * @return StoreSubCategory the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = StoreSubCategory::findOne(['id' => $id])) !== null) {
            return $model;
        }
